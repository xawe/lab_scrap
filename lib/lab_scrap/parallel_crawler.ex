defmodule LabScrap.ParallelCrawler do
  @moduledoc """
  ...
  """
  def run_1x1() do
    LabScrapWeb.Scrap.AllRecipes.get_smoothies_recipe()
  end
  ...
  def run_1x1_monitor() do
    :timer.tc(fn -> LabScrapWeb.Scrap.AllRecipes.get_smoothies_recipe() end)
  end
  ...
  def run_pool(pool_count) do
    LabScrapWeb.Scrap.AllRecipes.get_smoothies_recipe(pool_count)
  end
